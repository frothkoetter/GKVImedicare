...
CREATE EXTERNAL TABLE cms.cmsml_parquet 
STORED AS PARQUET 
LOCATION '/tmp/cmsml/'
TBLPROPERTIES ('transactional'='false')
AS select * from cms.cmsml;

INSERT OVERWRITE TABLE cms.cmsml_parquet  Select * from cms.cmsml;
select count(1) from cms.cmsml_parquet

select * from cms.cmsml_parquet limit 3;